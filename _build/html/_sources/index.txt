...
Welcome to the Tox API documentation!
=======================================

Welcome!
The Tox Docs project seeks to document the the toxcore library and and bindings, for future generations of developers.
...
Getting started
==================
`Understanding a Tox ID <pubkey.html>`_
...
* TOX_USERSTATUS tox_get_user_status
* TOX_USERSTATUS tox_get_self_user_status
